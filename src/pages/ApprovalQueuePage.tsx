...
export default function ApprovalQueuePage() {
  ...
  const renderTicketList = (tickets: typeof approvalTickets, showActions: boolean) => {
    if (tickets.length === 0) {
      return (
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        {showActions && ticket.needsApproval && (
                          <Badge variant="outline" className="text-[10px] border-status-pending text-status-pending">
                            Butuh Persetujuan
                          </Badge>
                        )}
                      </div>
