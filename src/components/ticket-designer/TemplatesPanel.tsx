import { TicketDesign, defaultTicketDesign } from '@/types/ticket';
import { Label } from '@/components/ui/label';
import { Fish, Waves, TreePalm, Sunset, Mountain, Anchor, LucideIcon } from 'lucide-react';

interface TemplatesPanelProps {
  currentDesignId: string;
  onSelectTemplate: (design: Partial<TicketDesign>) => void;
}
...
export function TemplatesPanel({ currentDesignId, onSelectTemplate }: TemplatesPanelProps) {
  return (
